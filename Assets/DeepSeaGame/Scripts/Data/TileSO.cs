...
namespace DeepSeaGame
{
    ...
    public class TileSO : RuleTile
    {
        ...
        [field: SerializeField] public TileBreakMode BreakMode { get; private set; } = TileBreakMode.SingleTileHit;
        ...
        [field: SerializeField] public EventReference MiningSFX { get; private set; }
        [field: SerializeField] public EventReference PlaceSFX { get; private set; }
        [field: SerializeField] public EventReference DestroySFX { get; private set; }
